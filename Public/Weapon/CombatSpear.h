...
#include "CombatSpear.generated.h"

/**
 * 
 */
UCLASS()
class SCIFICOMBAT_API ACombatSpear : public AMeleeWeaponBase
{
	GENERATED_BODY()
public:
	...
	UPROPERTY(EditAnywhere, Category = MeleeAttackOption)
	class UAnimationAsset* swing_anim_sequence4;
	UPROPERTY(EditAnywhere, Category = MeleeAttackOption)
	class UAnimationAsset* swing_anim_sequence5;
	...
	UPROPERTY(EditAnywhere, Category = MeleeAttackOption)
	float attack_dash_reset_delay4 = 0.4f;
	UPROPERTY(EditAnywhere, Category = MeleeAttackOption)
	float attack_dash_reset_delay5 = 0.4f;
